package dev.itzrozzadev.core.item;

import dev.itzrozzadev.core.exception.BaseException;
import dev.itzrozzadev.core.reflection.ReflectionUtil;
...
public class SkullCreator {
	...
	private static String urlToBase64(final String url) {
		if (!url.startsWith("http://")) {
			throw new BaseException("(!) URL for skull must start with http:// or https://, given: " + url);
		}
